<aside class="max-w-62.5 ease-nav-brand z-10 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent hide-scrollbar">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-screen grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a href="{{ route('admin.user') }}" class="@if (request()->routeIs('admin.user')) bg-white shadow-soft-xl rounded-lg font-semibold text-slate-700 @endif py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
            <div class="@if (request()->routeIs('admin.user')) bg-gradient-to-tl from-purple-700 to-pink-500 @endif shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-1.5">
              <svg class="@if (request()->routeIs('admin.user')) fill-white @else fill-slate-800 @endif" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="user">
